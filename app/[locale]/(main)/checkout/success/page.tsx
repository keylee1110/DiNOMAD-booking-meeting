...
export default function CheckoutSuccessPage({
  ...
  useEffect(() => {
    if (isLoading || waitingForBookings || !confirmedBooking || !room) return
  ...
  }, [confirmedBooking, room, isLoading, waitingForBookings, locale, state.guestEmail, state.guestName])
